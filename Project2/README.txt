...
(2)The part1 package contains the implementation files for part1 of this project. The Extractor file defines the class Extractor which is used in part1 for extracting information from the Json result of Freebase API. And pojo package under part1 package contains object definitions for different types in the result.
